...
class PriorityQueue<E, P> {
    ...
    public Node add(E e, P priority) {
        ...
        // Node object created with element and priority
        Node node = new Node(e, priority, size());

        tree.add(node); // add to the end of the array
        pullUp(size() - 1); // pull up to correct location
    ...
    public boolean contains(E e) {
        ...
        // Loop through array, check if element is in queue
